    ...
    static void Main(string[] args)
    {
        ...
        for (int i = 0; i < engineLines; i++)
        {
            ...
            if (engineInfo.Length > 2)
            {
                ...
                if (displacementAvailable) tempEngine.displacement = engineInfo[2];
                else tempEngine.efficiency = engineInfo[2];
            }
        ...
        for (int i = 0; i < numberOfCars; i++)
        {
            ...
            {
                if (engine.model == engineName) tempEngine = engine;
            }
            ...
            if (carsInfo.Length > 2)
            {
                ...
                if (weightAvailable) tempCar.weight = carsInfo[2];
                else tempCar.colour = carsInfo[2];
            }
